...
import com.mahindra.epcfrm.entity.DeliveryChalan;
import com.mahindra.epcfrm.entity.InstReportPhotos;
...
public class LeadMasterDTO extends BaseEntity {
	...
	// status
	private List<InstReportPhotos> instReportPhoto;
	private String instReportVideo;

	private List<DeliveryChalan> deliveryChalan;
	...
	public List<InstReportPhotos> getInstReportPhoto() {
		return instReportPhoto;
	}

	public void setInstReportPhoto(List<InstReportPhotos> instReportPhoto) {
	...
	public List<DeliveryChalan> getDeliveryChalan() {
		return deliveryChalan;
	}

	public void setDeliveryChalan(List<DeliveryChalan> deliveryChalan) {
